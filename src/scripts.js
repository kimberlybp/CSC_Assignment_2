...
(function () {
    ...
    function newCommentReceived(data) {
        var newCommentHtml = commentTemplate.innerHTML.replace('{{fname}}', data.fname);
        newCommentHtml = newCommentHtml.replace('{{lname}}', data.lname);
    ...
    function addNewComment(event) {
        ...
        var newComment = {
            fname: document.getElementById('new_comment_fname').value,
            lname: document.getElementById('new_comment_lname').value,
